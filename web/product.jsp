                                ...
                                <div class="col-md-4 margin_bottom1">
                                    <form action = 'basket.html' method = 'POST'>
                                        ...
                                        <div class="product_box">
                                            <figure><img src="images/km_jbl_propond_all_seasons_s_1l_41246_1-300x300.png"  alt="#"/></figure>
                                            <h3>                                             
                                                <%
                                        ...
                                        <div class="product_box">
                                            <figure><img src="images/png-transparent-rectangular-glass-aquarium-reef-aquarium-gallon-pet-tropical-fish-fish-tank-miscellaneous-glass-furniture-removebg-preview.png"  alt="#"/></figure>
                                            <h3>
                                        ...
                                        <div class="product_box">
                                            <figure><img src="images/e368c44cd17f10c961f1e1d1112dbe20.png"  alt="#"/></figure>
                                            <h3>                                           
                                                <%
                                                    for (Product prod
                                                            : pService.getProducts()) {
                                        ...
                                        <div class="product_box">
                                            <figure><img src="images/prionobrama_filigera_uveglazac_akvariumi_hal.webp"  alt="#"/></figure>
                                            <h3>
                                        ...
                                        <div class="product_box">
                                            <figure><img src="images/Artificial-Plant-Green-Pink-Plant-Fish-Tank-Decoration-Aquarium-Decoration-Ornaments-Aquatic-Supplies-Length-about-10cm-removebg-preview.png" alt="#"/></figure>
                                            <h3>
                                        ...
                                        <div class="product_box">
                                            <figure><img src="images/anubias-barteri-var-barteri-topf-removebg-preview.png" alt="#"/></figure>
                                            <h3>
                                        ...
                                        <div class="product_box">
                                            <figure><img src="images/Cryptocoryne_crispatula-removebg-preview.png" alt="#"/></figure>
                                            <h3>
                                        ...
                                        <div class="product_box">
                                            <figure><img src="images/Vesicularia-dubyana-Czech-Supplier-removebg-preview.png" alt="#"/></figure>
                                            <h3>
                                        ...
                                        <div class="product_box">
                                            <figure><img src="images/Marimo-Russian-3-Underwater-Mini-Moss-Ball-removebg-preview.png" alt="#"/></figure>
                                            <h3>
                                                <%
                                                    for (Product prod
                                                            : pService.getProducts()) {
                                        ...
                                        <div class="product_box">
                                            <figure><img src="images/guppi-petguru.hu_.webp" alt="#"/></figure>
                                            <h3>
                                                <%
                                                    for (Product prod
                                                            : pService.getProducts()) {
                                            ...
                                            <div class="product_box">
                                            <figure><img src="images/szumi2.jpg" alt="#"/></figure>
                                            <h3>
                                                <%
                                                    for (Product prod
                                                            : pService.getProducts()) {
                                            ...
                                            <div class="product_box">
                                            <figure><img src="images/Teljes-képernyő-rögzítése-2018.-10.-31.-133456-1.jpg" alt="#"/></figure>
                                            <h3>
                                                <%
                                                    for (Product prod
                                                            : pService.getProducts()) {
                                        ...
                                        <div class="col-md-12">
                                                ...
                                                <input class="btn" type = 'submit' value = 'Rendelés'/>
